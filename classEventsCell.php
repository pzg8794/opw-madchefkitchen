...
<body>
		...
		<form method="post" action="<?php echo $PHP_SELF;?>">  <!-- ----------------------------------------------------------------------------------- -->
			<table width="100%"> <!-- ---------------------------------------------------------------------------------------------------------- -->
				<tr> 	<!--FIELD FOR THE NAME OF THE CLASS-------------------------------------------------------------------------------- -->
    					...
    					<td valign="top"> 
  						<input  type="text" required autocomplete="on" name="Class_Name" maxlength="50" size="20">
					</td>
				</tr>	<!--FIELD FOR THE NAME OF THE CLASS------------------------------------------------------------ -->
				...
				<tr>	<!--FIELD FOR THE LOCATION OF THE CLASS----------------------------------------------------------------------- -->
 					...
 					<td valign="top">
					 	<input id="lebel1" type="text" name="Class_Location" size="20" maxlength="30" 
	...
	<div style="float:right; margin-top:0px; text-align: aligncenter"> 	
		<h2> <br>Load Multiple Classes </h2>
