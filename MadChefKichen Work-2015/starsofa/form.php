...
<html lang=en>
	<head>
		...
		#submit{
			...
			div.day-numb		
			{ 	
				background:#5F9EA0; padding:5px; color:white; font-weight:bold; 
				float:left; margin:8px -10px 8px -10px; 
	...
	<body>
		...
		<form name="calendar" method="post" id="calendar" action="<?php echo $PHP_SELF;?>">
			<table width="100%">					
				<tr>	<!--  FIELD FOR THE USER TO ENTER THE DATE OF THE EVENT-->
		 			<td valign="top"> 
						<?php
							$y=date('Y');	$m= date('m', strtotime('-0 month')); 
							$monthName = date("F", mktime(null, null, null, $m));
							echo '<h2 align="center" >Cooking Classes for '. $monthName.' '.$y.'</h2>';
				...
				<tr>	
		 			<td align = "center" valign="top"> 
						<label> Select Month and, or, Year to See Upcoming Classes </label> <br/>
						<?php
							date_default_timezone_set('America/Los_Angeles'); 
							$date =date('Y-m-d');
						?>
			
						<select name="cyear" onchange="document.getElementById('calendar').submit()">
							<?php
								$y=date('Y');
								echo '  <option value="' . $y . '">' . 'Year' . '</option>' . PHP_EOL;
						...
						<select name="cmonth" onchange="document.getElementById('calendar').submit()"> 
							<?php			
								$m=date('m', strtotime('-0 month')); 					
								echo '  <option value="' . $m . '">' . 'Month' . '</option>' . PHP_EOL;
								for ($m=1; $m<=12; $m++) 
								{
	...
	<div id="form">  
		...
		<form name="registration" method="post" action="<?php echo $PHP_SELF;?>">
			...
			<table width="450px">			
				<tr> 	<!--  FIELD FOR THE USER TO ENTER A NAME -->
					<td valign="top"> 
 					...
 					<td valign="top">	
						<input type="name" required autocomplete="on" align="right" name="Stname" placeholder="Name Required" size="25" maxlength="30" 
				...
				<tr>	<!--  FIELD FOR THE USER TO ENTER AN EMAIL ADDRESS -->
		 			...
		 			<td valign="top">
  						<input type="Stemail" required autocomplete="on" align="right" name="Stemail" placeholder="Email Required" size="25" maxlength="30" 
				...
				<tr>	<!--  FIELD FOR THE USER TO ENTER A NUMBER -->
					...
					<td valign="top">
  						<input type="text"required autocomplete="on" name="Stnumber" placeholder="Nunmber Required" size="25" maxlength="30" 
				...
				<tr>	<!--  FIELD FOR THE USER TO ENTER AN ADDRESS -->
					...
					<td valign="top">
  						<div class="field-wrap" style="margin-left:-3.5%;">
							<label>
				...
				<tr>	<!--  FIELD FOR THE USER TO  -->
 					<td colspan="2">
						<p style="margin-left:0%; margin-top:0%; text-align:center"><input type="Submit" id="submit" name="action" value="REGISTER"/></p>
 					</td>
				</tr>
			</table>
		</form> 
		...
		<div id="contentt"> 
			<?php
				...
				{	
					...
					$price = $classes[$num]['Class_Price'];
					$temp = "Class : ". $classes[$num]['Class_Name']."\r\n";
					$temp .= "Date : ". $classes[$num]['Class_Date']."\r\n";
					$com  = $temp."Description : ".$classes[$num]['Comments']."\r\nPrice: $".$price." USA";
				

        			echo '<div class="day-numb" style="background-color:'.$col.'"></div>  
					<a href="#" data-toggle="tooltip" title="'.$com.'"><p>'.$name.'</p></a>';
					$num++;
				}
			?>
		</div>
