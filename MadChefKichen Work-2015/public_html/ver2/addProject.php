		...
		<div class='container'>
			...
			<div id='content'><!--Start of page content. -->
				...
				<form action="addProject.php" method="post">
					<p><label for="project_name">Project Name:</label>
					...
					<?php 
						...
						// build years menu
						echo '<select class="form-inline" name="year">' . PHP_EOL;
						...
						// build months menu
						echo '<select class="form-inline" name="month">' . PHP_EOL;
						for ($m=1; $m<=12; $m++) {
						...
						// build days menu
						echo '<select class="form-inline" name="day">' . PHP_EOL;
						for ($d=1; $d<=31; $d++) {
					...
					<?php 
						...
						// build years menu
						echo '<select class="form-inline" name="year2">' . PHP_EOL;
						...
						// build months menu
						echo '<select class="form-inline" name="month2">' . PHP_EOL;
						for ($m=1; $m<=12; $m++) {
							echo '  <option value="' . $m . '">' . date('M', mktime(0,0,0,$m)) . '</option>' . PHP_EOL;
						}
						echo '</select>' . PHP_EOL;
						...
						// build days menu
						echo '<select class="form-inline" name="day2">' . PHP_EOL;
						for ($d=1; $d<=31; $d++) {
							echo '  <option value="' . $d . '">' . $d . '</option>' . PHP_EOL;
						}
						echo '</select>' . PHP_EOL;
					...
					<p>
						...
						<input id="attachment" type="file" name="attachment" size="12" maxlength="12"
					...
					<p><button class="btn btn-default" id="submit" type="submit" name="submit" value="Add Project">Add</button></p>
