...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (empty($_POST['contact_fname'])){
		$errors[] = 'You Did Not Enter The Contact Name.';
	}
	else{
...
if(mysqli_num_rows($result) == 1){ // Valid user ID, display the form.
  ...
  <p><label class="label" for="serialnumber">Serial Number:</label>
  ...
  <p>
    <label class="label" for="addr1">Contact Primary Address:</label>
    <input class="fl-left" type="text" name="addr1" size="30" maxlength="60"
    value="'.$row[2].'">
  </p>
  
  <p>
    <label class="label" for="addr2">Contact Secundary Address:</label>
