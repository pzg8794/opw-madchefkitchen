    					...
    					else
					{
						...
						{	
							...
							echo '<h3> Event Was Registered Succesfully </h3>';
 							...
 							$email_to = $uN;
 							$email_subject = "Thanks For Solicitating Our Services";
							$comments = "Thanks for using MadChefKitchen Services for your event.
							...
							{ 
 			   				...
 			   				$email_message .= "Name: ".clean_string($uN)."\n";
    							$email_message .= "Email: ".clean_string($uE)."\n";
    							$email_message .= "Telephone: ".clean_string($uNr)."\n";
		    					$email_message .= "Comments: ".clean_string($comments)."\n";
 
							// create email headers 
							$headers = 'From: '."Dave@madchefkitchen.com"."\r\n".
							'Reply-To: '."Dave@madchefkitchen.com"."\r\n" .
