...
<head>
	...
	<!-- CSS CODE FOR THE CALENDAR AND EVENTS -->  	
 	<style type ="text/css">
   		...
   		h
		{
	    	...
	    	/* CSS CODE TO MIDIFY THE CONTENT OF AN EVENT */
    		cevent
		{
    			font-color:black;
    			font-size:10px;
		...
		{ 
	    	...
	    	/* CSS CODE TO MODIFY SIZE OF THE TITLE-DAY TITLE*/ 
  		td.calendar-day-head 	
		{ 
			background: #5F9EA0; color: white; font-size:13px; font-weight:bold; text-align:center; 
			width:10px; padding:5px; border-bottom:2px solid black; 
			border-top:2px solid black; border-right:2px solid black; 
		}

	    	/* SQUARES WITH DIFFERENT COLORS USED TO COLOR REFERENCE THE EVENTS */  
