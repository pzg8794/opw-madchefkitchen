...
?>
	...
	<div id="sidebar2">   
		...
		<?php 	} ?>
        		...
        		<img id="octagon"
			<p> <strong><span style="font-family:; font-size: 5pt; color: black;"><a href="#" data-toggle="tooltip" title="
...
your pantry.">  
		...
		<?php 	
			if (browsers() == "Chrome")
			{ ?>
				<div style="float:right; margin-top: -0px; margin-left: -0px"> 
		<?php 	} 
		...
		<?php 	} 
			if (browsers() == "Safari")
			{ ?>
				<div style="float:right; margin-top: -215px; margin-left: 150px"> 
		<?php 	} 
			if (browsers() == "Firefox")
			{ ?>
				<div style="float:right; margin-top: -215px; margin-left: 100px"> 
		<?php 	} ?>
