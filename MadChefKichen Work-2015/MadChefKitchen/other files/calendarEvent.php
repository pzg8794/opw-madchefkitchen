	...
	<meta charset=utf-8>
 	...
 	<style type ="text/css">
		...
		table.calendar		{ border-left:2px solid black; }
    		...
    		div.day-number11	{ 	background:gray; padding:5px; color:white; font-weight:bold; 
						float:right; margin:-5px -5px 0 0; 
						width:30px; text-align:center; 
					}

    		div.day-number10	{ 	background:#00FF00; padding:5px; color:white; font-weight:bold; 
						float:right; margin:-5px -5px 0 0; 
						width:30px; text-align:center; 
					}

    		div.day-number9		{ 	background:#99FF00; padding:5px; color:white; font-weight:bold; 
						float:right; margin:-5px -5px 0 0; 
						width:30px; text-align:center; 
					}

    		div.day-number8		{ 	background:#00FFFF; padding:5px; color:white; font-weight:bold; 
						float:right; margin:-5px -5px 0 0; 
						width:30px; text-align:center; 
					}


    		div.day-number7		{ 	background:brown; padding:5px; color:white; font-weight:bold; 
						float:right; margin:-5px -5px 0 0; 
						width:30px; text-align:center; 
					}
    		...
    		div.day-number2		{ 	background:#CCFF00; padding:5px; color:white; font-weight:bold; 
						float:right; margin:-5px -5px 0 0; 
						width:30px; text-align:center; 
					}
...
//$datef;
//$q = "SELECT * FROM Classes WHERE Class_Date = '$datef'";
//$rs = @mysqli_query($dbcon, $q); 
//echo $num = mysqli_num_rows($rs);	//echo " $num_users users ";
//echo $num;
...
$num = sizeof($array);
							...
							if($num > 0)
							{
								for($count = 0; $count<$num; $count++)
								{
									...
									$temp2 = '<div class="day-number" style="background-color:red">'.$list_day.'</div>';
					...
					echo '<h2 align="center" >Cooking Classes for September 2015</h2>';
					echo draw_calendar(date('m', strtotime('-0 month')),2015);

					echo '<h2 align="center" >Cooking Classes for October 2015</h2>';
					echo draw_calendar(date('m', strtotime('+1 month')),2015);
				?>
