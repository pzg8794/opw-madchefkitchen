 	...
 	<style type ="text/css">
		...
		table.calendar		{ border-left:2px solid black; }
    		...
    		td.calendar-day-head 	{ 
						background: #FDD414; color: #8B0000; font-weight:bold; text-align:center; 
						width:120px; padding:5px; border-bottom:2px solid black; 
						border-top:2px solid black; border-right:2px solid black; 
					}

    		div.day-number		{ 	background:#8B0000; padding:5px; color:white; font-weight:bold; 
						...
						for($list_day = 1; $list_day <= $days_in_month; $list_day++):
							...
							if($num > 0)
							{
								for($count = 0; $count<$num; $count++)
								{
									...
									$name = $array[$count]['Class_Name'];
				
									$price = $array[$count]['Class_Price'];
									$tp = "Class : ". $array[$count]['Class_Name']."\r\n";
									$tp .= "Date : ". $array[$count]['Class_Date']."\r\n";
									$com  = $tp."Description : ".$array[$count]['Comments']."\r\nPrice: $".$price." USA";
