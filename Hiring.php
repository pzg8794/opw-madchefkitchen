		...
		<form method="post" action="<?php echo $PHP_SELF;?>">
			...
			<table width="450px">
				...
				<tr>	<!--  FIELD FOR THE USER TO ENTER THE NUMBER OF PEOPLE ATTENDING THE EVENT -->
					...
					<td valign="top">
  						<input id="uNoP" required autocomplete="on" type="text" name="uNoP" placeholder="Required" size="10" maxlength="10"/><br />
					</td>
				</tr>
				...
				<tr>	<!--  FIELD FOR THE USER TO ENTER ANY DIETARY RESTRICTIONS -->
					...
					<td valign="top">
 						<textarea name="dRes" cols="40" rows="5" placeholder="Not Required" id="dRes"></textarea><br />
				...
				<tr>	<!--  FIELD FOR THE USER TO ENTER ANY REQUIREMENT-->
					...
					<td valign="top">
 						<textarea name="sReq" cols="40" rows="5" placeholder="Not Required" id="sReq"></textarea><br />
  						<input type="hidden" name='articleid' id='articleid' 
				...
				<table width="100%" height="202" border="1">
					<tr>	<!--  FIELD EXPLAINING TERMS OF THE AGREEMENT TO THE USER-->
							...
							<p minmax_bound="true">
								<label style="text-align: justify; font-weight:normal"> 
									The following is the <a style="color:red" href="url">terms of the agreement</a> between MadChefKitchen and the buyer of goods/services through this site. 
									If you do not agree to these <a href="url">terms</a>, you will not be able to purchase anything, so please review these <a href="url">terms</a> carefully. 
								</label>
							</p>
	    						<p minmax_bound="true">
									<label style="text-align: justify; font-weight:normal"> 
										By accepting the <a style="color:red" href="url">terms</a>,  you are entering into a contract. 
								</label>
							</p>
						</td>
  					</tr>
		...
		<?php get_template_part('calendar'); 
			...
			if($_SERVER['REQUEST_METHOD'] == 'POST') 
			{
				...
				{ 	//If no problems encountered //make the query
					...
					uAddress1=' ' AND uAddress2=' ' AND uCity=' ' AND uZip=' ' AND nop='$nop' 
					...
					{	
        				...
        				$errors2[] = 'Testing!';
     	 				$q = "INSERT INTO Clients (uName, uEmail, uNumber, nop, eDate, sTime, eTime, mealtype, need, dRes, sReq, ReqDate, ReqTime)
				    	VALUES('$uN', '$uE', '$uNr','$nop', '$m', '$tm', '$etm', '$srad1','$srad2','$dres', '$sreq', '$cdate', '$ctime ')";
						...
						{	
							...
							$subject = "A New User Has Hired A Chef";
