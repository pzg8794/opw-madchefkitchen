...
<body>
	<div id="container2">
		...
		<?php get_template_part('calendarCell'); ?>
	</div>
			...
			<table width="100%">
				<tr> 	<!--  FIELD FOR THE USER TO ENTER A NAME -->
					<td valign="top"> 
 					...
 					<td valign="top">
  						<input  type="text" required autocomplete="on" name="uName" maxlength="50" size="25"/>
 					</td>
				</tr>
				...
				<tr>	<!--  FIELD FOR THE USER TO ENTER AN EMAIL ADDRESS -->
		 			...
		 			<td valign="top">
  						<input  type="text" required autocomplete="on" name="uEmail" maxlength="80" size="25"/>
 					</td>
 				</tr>
				...
				<tr>	<!--  FIELD FOR THE USER TO ENTER A NUMBER -->
					...
					<td valign="top">
  						<input  type="text" required autocomplete="on" name="uNumber" maxlength="30" size="25"/>
 					</td>
				</tr>
